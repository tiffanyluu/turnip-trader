export const turnipGuides = [
  ...
  },
  {
    ...
    content:
      "If Monday and Tuesday prices keep dropping, you're likely in a decreasing pattern. Cut your losses early - sell by Wednesday if possible. Waiting longer will only make losses worse. Better to lose 20-30% than 60-80%.",
  },
  {
  ...
  },
  {
    ...
    content:
      "Never invest more than you can afford to lose. Diversify by visiting friends' islands for better prices. Keep track of your patterns week to week. If you've had decreasing patterns recently, you're more likely to get a spike pattern next week.",
  },
  {
    title: "Using Online Tools and Communities",
    content:
      "Join turnip trading communities to find islands with good prices. Use prediction tools to forecast your week's pattern. Share your prices to help others. Remember that patterns can change, so always have a backup plan.",
  },
  {
    title: "Common Mistakes to Avoid",
    content:
      "Don't hold turnips past Saturday - they rot Sunday morning. Don't panic sell on Monday unless prices are really good. Don't ignore daily price checks. Don't travel backwards in time as it will rot your turnips instantly.",
  },
];